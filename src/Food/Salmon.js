// This is the salmon page that fetches information from the api regarding its pairing with wine
...
function Salmon() {
    ...
    const { data, loading } = useAPI(
        ...
        "https://api.spoonacular.com/food/wine/pairing?food=salmon&apiKey=APIKEY"
      );
